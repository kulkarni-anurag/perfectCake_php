...
<head>
    ...
    <title>The Perfect Cake - Login</title>
      ...
      $(document).ready(function () {
            ...
            $("#login").click(function () {
                ...
                $.ajax({
                    ...
                    beforeSend: function () {
                        $("#add_err2").html('<div class="alert alert-warning">Authenticating...</div>');
                    }
                });
                return false;
            });
            ...
            <div class="box">
                <div class="col-lg-12">
                  <div class="alert alert-danger">
                    <strong>You must be logged in to view the content.</strong>
                  </div>
                    <hr>
